                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7">
                                            <div class="text-center">
                                                ...
                                                <h4 class="mb-3"><i class="bx bxs-quote-alt-left text-primary h1 align-middle me-3"></i><span class="text-primary">44</span></h4>

                                                <div dir="ltr">
                                                    <div class="owl-carousel owl-theme auth-review-carousel" id="auth-review-carousel">
                                                        <div class="item">
                                                            <div class="py-3">
                                                                <p class="font-size-16 mb-4">" Aqui puedes puedes poner lo que quieras"</p>

                                                                <div>
                                                                    <h4 class="font-size-16 text-primary">Comentario</h4>
                                                                    <p class="font-size-14 mb-0">- Benedey</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="item">
                                                            <div class="py-3">
                                                                <p class="font-size-16 mb-4">" Aqui puedes poner algo mas"</p>
